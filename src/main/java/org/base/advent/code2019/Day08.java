 ...
 * <ul>
 *      <li>The top-left pixel is black because the top layer is 0.</li>
 *      <li>The top-right pixel is white because the top layer is 2 (transparent), but the second layer is 1.</li>
 *      <li>The bottom-left pixel is white because the top two layers are 2, but the third layer is 1.</li>
 *      <li>The bottom-right pixel is black because the only visible pixel in that position is 0 (from layer 4).</li>
 * </ul>
