...
public class Solutions2025UnitTests extends PuzzleTester {
    ...
    public void verifyDay08() {
        testSolutions(new Day08(1000), readLines("/2025/input08.txt"),
                175440, Pair::getLeft,
    ...
    public void verifyDay10() {
        testSolutions(new Day10(pool), readLines("/2025/input10.txt"),
                390, Pair::getLeft,
                14677L, Pair::getRight);
    }

    @Test
    public void verifyDay11() {
        testSolutions(new Day11(pool), readLines("/2025/input11.txt"),
                574, Pair::getLeft,
                306594217920240L, Pair::getRight);
    }
