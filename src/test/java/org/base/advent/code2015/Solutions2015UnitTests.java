...
public class Solutions2015UnitTests {
	...
	public void verifyDay08() throws Exception {
		...
		assertEquals(1333, day08.solvePart1());
		assertEquals(2046, day08.solvePart2());
	}

	@Test
	public void verifyDay09() throws Exception {
		final Day09 day09 = new Day09();
		assertEquals(207, day09.solvePart1());
		assertEquals(804, day09.solvePart2());
	}

	@Test
	public void verifyDay10() throws Exception {
		final Day10 day10 = new Day10();
		assertEquals(492982, day10.solvePart1());
		assertEquals(6989950, day10.solvePart2());
	}

	@Test
	public void verifyDay11() throws Exception {
		final Day11 day11 = new Day11();
		assertEquals("vzbxxyzz", day11.solvePart1());
		assertEquals("vzcaabcc", day11.solvePart2());
	}

	@Test
	public void verifyDay12() throws Exception {
		final Day12 day12 = new Day12();
		assertEquals(111754, day12.solvePart1());
		assertEquals(65402, day12.solvePart2());
	}

	@Test
	public void verifyDay13() throws Exception {
		final Day13 day13 = new Day13();
		assertEquals(733, day13.solvePart1());
		assertEquals(725, day13.solvePart2());
	}
	
    @Test
    public void verifyDay14() throws Exception {
        final Day14 day14 = new Day14();
        assertEquals(2696, day14.solvePart1());
        assertEquals(1084, day14.solvePart2());
    }

    @Ignore @Test
    public void verifyDay15() throws Exception {
        final Day15 day15 = new Day15();
        assertEquals(258, day15.solvePart1());
        assertEquals(53, day15.solvePart2());
    }

    @Ignore @Test
    public void verifyDay16() throws Exception {
        final Day16 day16 = new Day16();
        assertEquals(543913, day16.solvePart1());
        assertEquals(14687245, day16.solvePart2());
    }

    @Ignore @Test
    public void verifyDay17() throws Exception {
        final Day17 day17 = new Day17();
        assertEquals(46165, day17.solvePart1());
        assertEquals(14134, day17.solvePart2());
    }

    @Ignore @Test
    public void verifyDay18() throws Exception {
        final Day18 day18 = new Day18();
        assertEquals(1333, day18.solvePart1());
        assertEquals(2146, day18.solvePart2());
    }

    @Ignore @Test
    public void verifyDay19() throws Exception {
        final Day19 day19 = new Day19();
        assertEquals(217, day19.solvePart1());
        assertEquals(814, day19.solvePart2());
    }

    @Ignore @Test
    public void verifyDay20() throws Exception {
        final Day11 day11 = new Day11();
        assertEquals(492982, day11.solvePart1());
        assertEquals(6989951, day11.solvePart2());
    }
