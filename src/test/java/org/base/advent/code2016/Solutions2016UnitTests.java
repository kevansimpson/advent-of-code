...
/**
 * Verify answers for all AoC days in 2016.
 */
public class Solutions2016UnitTests {
    @Test
    public void verifyDay01() throws Exception {
        final Day01 day01 = new Day01();
        assertEquals(288, day01.solvePart1());
        assertEquals(111, day01.solvePart2());
    }

    @Test
    public void verifyDay02() throws Exception {
        final Day02 day02 = new Day02();
        assertEquals("76792", day02.solvePart1());
        assertEquals("A7AC3", day02.solvePart2());
    }

    @Test
    public void verifyDay03() throws Exception {
        final Day03 day03 = new Day03();
        assertEquals(982L, day03.solvePart1());
        assertEquals(1826L, day03.solvePart2());
    }
